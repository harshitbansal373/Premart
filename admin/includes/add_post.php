...
if(isset($_POST['create_post'])){
    ...
    $query = "INSERT INTO posts(post_title,post_category_id,post_status,post_user,post_image,post_tags,
    post_content,post_date) ";
    $query .= "VALUES( '{$post_title}','{$post_category_id}','{$post_status}','{$post_user}','{$post_image}','{$post_tags}',
    '{$post_content}', NOW() )";
