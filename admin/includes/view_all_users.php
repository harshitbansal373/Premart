    ...
    <table class="table table-hover table-dark table-bordered">
        <thead>
            <tr>
              ...
              <th scope="col">Change to customer</th>
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($select_all_users_query)){
              ...
              echo "<td><a href='users.php?customer=$user_id'>customer</td>";
...
if(isset($_GET['customer'])){
    $the_user_id = $_GET['customer'];

    // $query = "UPDATE users SET user_role = 'subscriber' WHERE user_id = $the_user_id";
    // $subscriber_query = mysqli_query($connection,$query);
    $query = "UPDATE users SET user_role = 'customer' WHERE user_id = ?";
    $stmt_customer_query = mysqli_prepare($connection,$query);
    mysqli_stmt_bind_param($stmt_customer_query, "s", $the_user_id);
    mysqli_stmt_execute($stmt_customer_query);
    mysqli_stmt_close($stmt_customer_query);
    header("Location:users.php");
