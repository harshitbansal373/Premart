...
if(isset($_POST['update_post'])){
    ...
    $query = "UPDATE posts SET post_title = '{$post_title}', post_category_id = '{$post_category_id}', 
            ...
            post_content = '{$post_content}', post_date = NOW() WHERE post_id = '{$the_post_id}'";
...
<form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="editor" name="post_content" rows="4"><?php echo $post_content; ?></textarea>
        </div>
        <div class="form-group">
